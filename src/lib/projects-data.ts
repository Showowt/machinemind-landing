...
export const projects: Project[] = [
  ...
  },
  {
    ...
    descriptionEs:
      "Restaurante japonés premium con Sofia AI para reservaciones y recomendaciones personalizadas.",
    descriptionEn:
      "Premium Japanese restaurant with Sofia AI for reservations and personalized recommendations.",
    category: "demo",
    subcategory: "restaurant",
